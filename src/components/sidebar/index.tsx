...
export const Sidebar = () => {
  ...
  return (
    <div
      className="border-r w-max border-gray-500 pt-5 h-screen"
      style={{ width: "300px" }}
    >
      <div className="text-white px-4">
        ...
        <ul className="pl-4 font-bold cursor-pointer">
          ...
          <li className="mt-2">
            <p
              className="flex items-center gap-2"
              style={{ color: randomeColor }}
            >
              {/* <FontAwesomeIcon icon="fa-solid fa-icons" className="h-4" /> */}
              NFT Galary
            </p>
          </li>
          <li className="mt-2">
        ...
        <ul className="pl-4 font-bold cursor-pointer">
          ...
          <li className="mt-2">
            <p className="flex items-center gap-2">
              {/* <FontAwesomeIcon icon="fa-solid fa-link" className="h-4" /> */}
              Join Discord
            </p>
          </li>
          <li className="mt-2">
            <p className="flex items-center gap-2">
              {/* <FontAwesomeIcon icon="fa-solid fa-bookmark" className="h-4" /> */}
              Make a suggestion
            </p>
          </li>
          <li className="mt-2">
            <p className="flex items-center gap-2">
              {/* <FontAwesomeIcon icon="fa-solid fa-outdent" className="h-4" /> */}
              DAO
            </p>
          </li>
        </ul>

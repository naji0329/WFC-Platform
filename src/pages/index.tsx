...

      {
        !wallet ? (
          <>
            ...
            <p className="p-2 rounded border-[#9553fb] text-white max-w-max m-auto text-lg mt-10 border " style={{border: "2px solid #9653fb"}}>
              A NEW WAY TO DONATE <span style={{color: "#9553fb"}}>SIMPLE-SAFE-DECENTRALIZED</span>
            </p>
          ...
          <>
            <h1 className='text-white text-center text-5xl mt-20'>
              LOG IN HOW
            </h1>
